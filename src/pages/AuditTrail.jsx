    ...
    <div className="p-6 max-w-[1400px] mx-auto">
      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-4 mb-6 shadow-sm space-y-3">
        <div className="flex items-center gap-4 flex-wrap">
          <div className="flex-1 min-w-[200px] max-w-sm"><SearchInput placeholder="Search actions, actors, targets, policies, traces..." value={searchQuery} onChange={setSearchQuery} /></div>
