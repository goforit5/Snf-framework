...
const apActivities = [
  { id: 'apa1', agentName: 'AP Processing Agent', action: 'matched 156 invoice line items to purchase orders — 3 variances detected', status: 'completed', confidence: 0.95, timestamp: '2026-03-15T08:15:00Z', timeSaved: '4.1 hrs', policiesChecked: ['3-Way Match Policy', 'PO Tolerance 2%'] },
  { id: 'apa2', agentName: 'AP Processing Agent', action: 'flagged 4 duplicate payments totaling $8,200 across Sysco and Medline invoices', status: 'completed', confidence: 0.97, timestamp: '2026-03-15T07:30:00Z', timeSaved: '1.5 hrs', costImpact: '$8,200 overpayment prevented' },
  { id: 'apa3', agentName: 'AP Processing Agent', action: 'processed 89 vendor payments for weekly ACH batch — all GL coded', status: 'completed', confidence: 0.96, timestamp: '2026-03-15T06:45:00Z', timeSaved: '3.8 hrs', policiesChecked: ['Payment Authorization Policy'] },
  { id: 'apa4', agentName: 'AP Processing Agent', action: 'verified vendor W-9 and insurance for 3 new vendor onboarding requests', status: 'completed', confidence: 0.92, timestamp: '2026-03-15T07:00:00Z', timeSaved: '45 min', policiesChecked: ['Vendor Onboarding 3.1'] },
  { id: 'apa5', agentName: 'AP Processing Agent', action: 'analyzing Medline contract pricing against March invoice for rate compliance', status: 'in-progress', confidence: 0.88, timestamp: '2026-03-15T08:30:00Z' },
];
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <Card title="Agent Activity" badge="Live">
          <AgentActivityFeed activities={apActivities} maxItems={5} />
        </Card>
