...
export function AgentSummaryBar({ agentName, summary, itemsProcessed, exceptionsFound, timeSaved, lastRunTime }) {
  return (
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-2xl px-5 py-3 mb-6">
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <p className="text-sm text-gray-700 flex-1 min-w-0">
          <span className="font-semibold text-blue-700">{agentName}</span>
          {' — '}
          {summary}
        </p>
        <div className="flex items-center gap-4 flex-shrink-0">
          {itemsProcessed != null && (
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-xs font-semibold text-gray-700 tabular-nums">{itemsProcessed}</span>
          ...
          {exceptionsFound != null && (
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-xs font-semibold text-gray-700 tabular-nums">{exceptionsFound}</span>
          ...
          {timeSaved && (
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-xs font-semibold text-gray-700">{timeSaved}</span>
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-2 text-center">
        <div>
          <p className="text-lg font-bold text-gray-900 tabular-nums">{actionsToday ?? 0}</p>
          <p className="text-[10px] text-gray-400">Actions</p>
        </div>
        <div>
          <p className="text-lg font-bold text-gray-900 tabular-nums">{exceptionsToday ?? 0}</p>
