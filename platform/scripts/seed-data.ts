...
export const HERO_DECISIONS: HeroDecision[] = [
  {
    id: '00000000-ae00-4001-8000-000000000001',
    traceId: '00000000-af00-4001-8000-000000000001',
    ...
    evidence: [
      { source: 'pcc', label: 'BIMS Score Trend (Last 3 Assessments)', value: '2026-01-15: 9/15 → 2026-02-15: 8/15 → 2026-04-10: 8/15 (stable)', confidence: 0.98 },
      { source: 'pcc', label: 'PHQ-9 Trend (Last 3 Assessments)', value: '2026-01-15: 14 → 2026-02-15: 13 → 2026-04-10: 12 (improving)', confidence: 0.97 },
      { source: 'pcc', label: 'Medication History', value: 'Donepezil 10mg QD started 2024-10-13 (18 months ago), no dose changes', confidence: 0.99 },
      { source: 'pcc', label: 'Behavioral Monitoring Log', value: '0 incidents in 90 days', confidence: 0.99 },
      { source: 'pcc', label: 'Prior GDR Attempt', value: '2025-10-15: BIMS decline 9→5 at day 14, dose restored to 10mg', confidence: 0.96 },
    ],
    governanceLevel: 4,
    priority: 'high',
    dollarAmount: null,
  ...
  {
    id: '00000000-ae00-4002-8000-000000000002',
    traceId: '00000000-af00-4002-8000-000000000002',
  ...
  {
    id: '00000000-ae00-4003-8000-000000000003',
    traceId: '00000000-af00-4003-8000-000000000003',
  ...
  {
    id: '00000000-ae00-4004-8000-000000000004',
    traceId: '00000000-af00-4004-8000-000000000004',
  ...
  {
    id: '00000000-ae00-4005-8000-000000000005',
    traceId: '00000000-af00-4005-8000-000000000005',
    ...
    evidence: [
      { source: 'regulatory', label: 'QM Preview — Antipsychotic Rate', value: '18.7% (threshold: 15%, national avg: 14.1%)', confidence: 0.96 },
      { source: 'regulatory', label: 'QM Preview — Catheter Use Rate', value: '4.8% (threshold: 3.5%)', confidence: 0.96 },
      { source: 'regulatory', label: 'Current Star Rating', value: '5 stars (at risk of drop to 4 stars)', confidence: 0.98 },
      ...
      { source: 'workday', label: 'Staffing Hours Trend (3 Months)', value: 'Feb: 3.42 HPRD → Mar: 3.28 HPRD → Apr: 3.15 HPRD (projected, CMS minimum: 3.48)', confidence: 0.94 },
    ],
    governanceLevel: 5,
    priority: 'critical',
    dollarAmount: null,
    ...
    sourceSystems: ['pcc', 'workday', 'regulatory'],
