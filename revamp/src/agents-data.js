...
export const AGENTS = [
  ...
  { id: 'mds',        name: 'MDS Coordinator',      domain: 'Clinical',  owner: 'DON',      sla: 'daily',    load: 96,  confidence: .93, override: .03, cost: 0.15, color: 'var(--violet)' },
  { id: 'wound-care', name: 'Wound Care Monitor',   domain: 'Clinical',  owner: 'DON',      sla: '2 hrs',    load: 44,  confidence: .90, override: .05, cost: 0.17, color: 'var(--violet)' },
  ...
  { id: 'pdpm',       name: 'PDPM Optimizer',       domain: 'Finance',   owner: 'Billing',  sla: 'weekly',   load: 12,  confidence: .91, override: .04, cost: 0.35, color: 'var(--green)' },
  ...
  { id: 'recruiting', name: 'Recruiting Pipeline',  domain: 'Workforce', owner: 'Admin',    sla: 'daily',    load: 47,  confidence: .85, override: .07, cost: 0.12, color: 'var(--accent)' },
  ...
  { id: 'marketing',  name: 'Marketing & BD',       domain: 'Admissions',owner: 'Admin',    sla: 'daily',    load: 24,  confidence: .83, override: .09, cost: 0.16, color: 'var(--amber)' },
  { id: 'pre-admit',  name: 'Pre-Admission Screen', domain: 'Admissions',owner: 'DON',      sla: '1 hr',     load: 16,  confidence: .88, override: .06, cost: 0.13, color: 'var(--amber)' },
  { id: 'transition', name: 'Care Transition',      domain: 'Admissions',owner: 'DON',      sla: '2 hrs',    load: 11,  confidence: .86, override: .07, cost: 0.14, color: 'var(--amber)' },
  ...
  { id: 'grievance',  name: 'Grievance Tracker',    domain: 'Quality',   owner: 'Admin',    sla: '4 hrs',    load: 18,  confidence: .87, override: .06, cost: 0.15, color: 'var(--red)' },
  { id: 'outcomes',   name: 'Outcomes Analysis',    domain: 'Quality',   owner: 'DON',      sla: 'weekly',   load: 8,   confidence: .84, override: .09, cost: 0.28, color: 'var(--red)' },
  { id: 'incident',   name: 'Incident Tracker',     domain: 'Quality',   owner: 'DON',      sla: '30 min',   load: 32,  confidence: .91, override: .04, cost: 0.11, color: 'var(--red)' },
  ...
  { id: 'transport',  name: 'Transportation',       domain: 'Operations',owner: 'Admin',    sla: 'daily',    load: 28,  confidence: .91, override: .04, cost: 0.06, color: 'oklch(.62 .10 215)' },
  { id: 'dietary-ops',name: 'Dietary Operations',   domain: 'Operations',owner: 'Admin',    sla: 'daily',    load: 63,  confidence: .89, override: .05, cost: 0.08, color: 'oklch(.62 .10 215)' },
  ...
  { id: 'regulatory', name: 'Regulatory Affairs',   domain: 'Legal',     owner: 'Legal',    sla: 'daily',    load: 14,  confidence: .85, override: .08, cost: 0.22, color: 'oklch(.60 .12 310)' },
  { id: 'real-estate',name: 'Real Estate & Leases', domain: 'Legal',     owner: 'Legal',    sla: 'weekly',   load: 4,   confidence: .92, override: .03, cost: 0.18, color: 'oklch(.60 .12 310)' },
  { id: 'risk-legal', name: 'Legal Risk Analysis',  domain: 'Legal',     owner: 'Legal',    sla: 'daily',    load: 9,   confidence: .82, override: .10, cost: 0.32, color: 'oklch(.60 .12 310)' },
  ...
  { id: 'govt',       name: 'Government Affairs',  domain: 'Strategic', owner: 'CEO',      sla: 'weekly',   load: 2,   confidence: .76, override: .11, cost: 0.55, color: 'oklch(.60 .10 340)' },
  { id: 'ir',         name: 'Investor Relations',   domain: 'Strategic', owner: 'CEO',      sla: 'weekly',   load: 4,   confidence: .86, override: .06, cost: 0.42, color: 'oklch(.60 .10 340)' },
  { id: 'strat-plan', name: 'Strategic Planning',   domain: 'Strategic', owner: 'CEO',      sla: 'monthly',  load: 1,   confidence: .80, override: .08, cost: 0.75, color: 'oklch(.60 .10 340)' },
];
